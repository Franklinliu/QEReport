...
\chapter{Fairness Verification} % Main chapter title
...
\Cref{Sec_RelatedWorks,Sec_Conclusion} compare \faircon with the related work and summarize the chapter, respectively.
